...
This knowledge base collects practical programming and embedded Linux know-how.

The goal is to keep the material:

- easy to edit as plain text
- easy to review in Git
- structured enough for AI-assisted drafting
- concrete enough to be useful during real engineering work

Start with the [Topic Map](topic-map.md), then create individual pages from the [Topic Page Template](topic-page-template.md).
