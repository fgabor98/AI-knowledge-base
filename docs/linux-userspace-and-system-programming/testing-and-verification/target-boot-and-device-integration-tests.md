...
This page covers how to prove the real rootfs, libc, kernel, DTB, permissions, init, and hardware combination works. It is part of Stage 16: Testing And Verification and focuses on behavior that must remain correct on a constrained or partially available embedded Linux target.

## Core Concepts

- the target boot and device integration tests contract;
...
- mental model and vocabulary for target boot and device integration tests;
...
automate boot, service-start, discovery, peripheral, reset, and timeout tests.
