...
This page covers why a program that works on the development machine can fail on the target. It is part of Stage 0: Environment And Mental Model and focuses on behavior that must remain correct on a constrained or partially available embedded Linux target.

## Core Concepts

- the host, target, abi, and rootfs lab contract;
...
- mental model and vocabulary for host, target, abi, and rootfs lab;
...
compile, deploy, inspect, and run one program with its target interpreter and libraries.
