...
This page covers how to distinguish ISO C, libc, POSIX, Linux-specific, and product-specific contracts. It is part of Stage 0: Environment And Mental Model and focuses on behavior that must remain correct on a constrained or partially available embedded Linux target.

## Core Concepts

- the posix, linux, libc, and manual pages contract;
...
- mental model and vocabulary for posix, linux, libc, and manual pages;
...
compare a system-call manual page, a libc wrapper manual page, and the target implementation.
