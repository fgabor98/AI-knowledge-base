...
This page covers how blocking, allocation, interruption, ownership, and lifetime shape every userspace design. It is part of Stage 0: Environment And Mental Model and focuses on behavior that must remain correct on a constrained or partially available embedded Linux target.

## Core Concepts

- the blocking, failure, and ownership model contract;
...
- mental model and vocabulary for blocking, failure, and ownership model;
...
make a call-by-call table of resources, failure returns, blocking behavior, and cleanup.
