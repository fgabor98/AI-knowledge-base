...
# Userspace, Kernel, And Hardware Boundary

## What Problem Does This Solve?

This page covers the path from a C function through libc and a system call to a kernel subsystem, driver, and hardware. It is part of Stage 0: Environment And Mental Model and focuses on behavior that must remain correct on a constrained or partially available embedded Linux target.

## Core Concepts

- the userspace, kernel, and hardware boundary contract;
...
- mental model and vocabulary for userspace, kernel, and hardware boundary;
...
trace a small program with strace and identify which work happens in each layer.
