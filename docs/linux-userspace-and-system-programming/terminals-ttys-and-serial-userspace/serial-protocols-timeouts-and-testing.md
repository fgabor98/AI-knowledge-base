...
This page covers how framing, checksums, resynchronization, partial messages, and disconnects should be handled. It is part of Stage 8: Terminals, TTYs, And Serial Userspace and focuses on behavior that must remain correct on a constrained or partially available embedded Linux target.

## Core Concepts

- the serial protocols, timeouts, and testing contract;
...
- mental model and vocabulary for serial protocols, timeouts, and testing;
...
implement a bounded serial protocol parser with a PTY-based fault-injection test.
