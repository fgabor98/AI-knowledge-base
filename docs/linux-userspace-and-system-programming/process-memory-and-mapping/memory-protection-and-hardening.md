...
This page covers how mprotect, guard pages, ASLR, PIE, NX, RELRO, and stack protections reduce failure impact. It is part of Stage 4: Process Memory And Mapping and focuses on behavior that must remain correct on a constrained or partially available embedded Linux target.

## Core Concepts

- the memory protection and process hardening contract;
...
- mental model and vocabulary for memory protection and process hardening;
...
inspect an executable’s protections and deliberately catch an invalid access in a test.
