...
This page covers how ext4, squashfs, UBI/UBIFS, eMMC/NAND, write amplification, and power loss affect applications. It is part of Stage 13: Persistent State, Storage, And Power-Loss Behavior and focuses on behavior that must remain correct on a constrained or partially available embedded Linux target.

## Core Concepts

- the embedded filesystems, wear, and durability contract;
...
- mental model and vocabulary for embedded filesystems, wear, and durability;
...
measure write behavior and design bounded logging for a constrained persistent medium.
