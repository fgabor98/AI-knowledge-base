...
This page covers how CPU, memory, I/O, scheduling, descriptors, queues, latency, and tail behavior are measured. It is part of Stage 14: Diagnostics, Debugging, And Performance and focuses on behavior that must remain correct on a constrained or partially available embedded Linux target.

## Core Concepts

- the userspace performance and resource measurement contract;
...
- mental model and vocabulary for userspace performance and resource measurement;
...
define a workload and report resource limits, latency, throughput, jitter, and evidence.
