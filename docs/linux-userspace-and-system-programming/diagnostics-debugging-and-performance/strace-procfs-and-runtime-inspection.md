...
This page covers how system-call traces and runtime pseudo-filesystems reveal blocking, descriptors, signals, and state. It is part of Stage 14: Diagnostics, Debugging, And Performance and focuses on behavior that must remain correct on a constrained or partially available embedded Linux target.

## Core Concepts

- the strace, procfs, and runtime inspection contract;
...
- mental model and vocabulary for strace, procfs, and runtime inspection;
...
diagnose a deliberately broken service using strace and proc/PID evidence.
