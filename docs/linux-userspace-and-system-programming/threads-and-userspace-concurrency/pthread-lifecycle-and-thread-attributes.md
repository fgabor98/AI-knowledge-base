...
This page covers how POSIX threads, stacks, attributes, TLS, joining, and detaching determine lifetime. It is part of Stage 6: Threads And Userspace Concurrency and focuses on behavior that must remain correct on a constrained or partially available embedded Linux target.

## Core Concepts

- the pthread lifecycle and thread attributes contract;
...
- mental model and vocabulary for pthread lifecycle and thread attributes;
...
create workers with explicit stack, name, join, and shutdown policy.
