...
This page covers how initialization, normal operation, reset, degraded mode, recovery, and shutdown become explicit states. It is part of Stage 17: Design And Architecture Patterns and focuses on behavior that must remain correct on a constrained or partially available embedded Linux target.

## Core Concepts

- the hardware service state machines and recovery contract;
...
- mental model and vocabulary for hardware service state machines and recovery;
...
implement a service state machine with retry budgets, backpressure, and safe hardware recovery.
