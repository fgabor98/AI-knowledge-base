...
This page covers how to choose between a command-line tool, long-running daemon, threads, and multiple processes. It is part of Stage 17: Design And Architecture Patterns and focuses on behavior that must remain correct on a constrained or partially available embedded Linux target.

## Core Concepts

- the utility, daemon, and process boundaries contract;
...
- mental model and vocabulary for utility, daemon, and process boundaries;
...
justify a process boundary from ownership, restart, privilege, latency, and failure-containment needs.
