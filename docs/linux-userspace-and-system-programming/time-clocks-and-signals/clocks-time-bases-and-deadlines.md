...
This page covers how wall-clock, monotonic, boottime, raw, and real-time clocks differ. It is part of Stage 5: Time, Clocks, And Signals and focuses on behavior that must remain correct on a constrained or partially available embedded Linux target.

## Core Concepts

- the clocks, time bases, and deadlines contract;
...
- mental model and vocabulary for clocks, time bases, and deadlines;
...
implement deadlines that remain correct across clock adjustments and suspend.
