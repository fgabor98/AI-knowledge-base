...
This page covers how sleeps, POSIX timers, timerfd, drift, missed deadlines, and watchdog intervals behave. It is part of Stage 5: Time, Clocks, And Signals and focuses on behavior that must remain correct on a constrained or partially available embedded Linux target.

## Core Concepts

- the timers and periodic work contract;
...
- mental model and vocabulary for timers and periodic work;
...
implement periodic work using absolute deadlines and record lateness.
