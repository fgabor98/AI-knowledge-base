...
This page covers how device nodes, uevents, sysfs topology, modaliases, rules, and permissions describe runtime devices. It is part of Stage 10: Hardware-Facing Userspace And Kernel UAPI and focuses on behavior that must remain correct on a constrained or partially available embedded Linux target.

## Core Concepts

- the devfs, sysfs, udev, and device discovery contract;
...
- mental model and vocabulary for devfs, sysfs, udev, and device discovery;
...
write a discovery diagnostic that correlates node, sysfs object, driver, and Device Tree.
