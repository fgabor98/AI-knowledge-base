...
This page covers how SocketCAN and control devices expose communication, keepalive, reset, and safety responsibilities. It is part of Stage 10: Hardware-Facing Userspace And Kernel UAPI and focuses on behavior that must remain correct on a constrained or partially available embedded Linux target.

## Core Concepts

- the can, watchdog, and control interfaces contract;
...
- mental model and vocabulary for can, watchdog, and control interfaces;
...
build a watchdog or CAN test client with explicit ownership and failure escalation.
