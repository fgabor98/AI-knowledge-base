...
This page covers how stream boundaries, partial transfers, resets, half-close, deadlines, and reconnect work. It is part of Stage 9: Userspace Networking and focuses on behavior that must remain correct on a constrained or partially available embedded Linux target.

## Core Concepts

- the tcp streams and reconnect contract;
...
- mental model and vocabulary for tcp streams and reconnect;
...
build a framed TCP client with bounded retry and reconnect behavior.
