...
This page covers how programs, processes, threads, PIDs, TIDs, process groups, and sessions relate. It is part of Stage 2: Processes And Program Lifetime and focuses on behavior that must remain correct on a constrained or partially available embedded Linux target.

## Core Concepts

- the process model and identifiers contract;
...
- mental model and vocabulary for process model and identifiers;
...
map a running service into a process tree and identify its inherited resources.
