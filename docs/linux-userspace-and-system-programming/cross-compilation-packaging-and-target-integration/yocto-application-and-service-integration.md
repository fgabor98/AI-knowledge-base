...
This page covers how recipes, package splitting, systemd integration, image composition, and read-only-rootfs policy assemble an application. It is part of Stage 15: Cross-Compilation, Packaging, And Target Integration and focuses on behavior that must remain correct on a constrained or partially available embedded Linux target.

## Core Concepts

- the yocto application and service integration contract;
...
- mental model and vocabulary for yocto application and service integration;
...
add the capstone service to a custom Yocto layer and verify the final image.
