...
This page covers how binaries, symbols, manifests, licenses, SBOMs, CVE evidence, and target version reporting stay connected. It is part of Stage 15: Cross-Compilation, Packaging, And Target Integration and focuses on behavior that must remain correct on a constrained or partially available embedded Linux target.

## Core Concepts

- the artifacts, provenance, and release identity contract;
...
- mental model and vocabulary for artifacts, provenance, and release identity;
...
produce a release manifest that identifies the application, rootfs, kernel, DTB, firmware, and symbols.
