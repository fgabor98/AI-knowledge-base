...
This page covers how interpreters, library search paths, symbols, build IDs, and debug files affect execution and diagnosis. It is part of Stage 15: Cross-Compilation, Packaging, And Target Integration and focuses on behavior that must remain correct on a constrained or partially available embedded Linux target.

## Core Concepts

- the dynamic loader and library deployment contract;
...
- mental model and vocabulary for dynamic loader and library deployment;
...
deploy a shared-library application with separate symbols and verify it on the target.
