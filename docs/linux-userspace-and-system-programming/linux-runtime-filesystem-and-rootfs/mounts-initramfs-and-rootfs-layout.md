...
This page covers how mounts, early userspace, and rootfs transitions determine application availability. It is part of Stage 1: Linux Runtime, Filesystem, And Rootfs and focuses on behavior that must remain correct on a constrained or partially available embedded Linux target.

## Core Concepts

- the mounts, initramfs, and rootfs layout contract;
...
- mental model and vocabulary for mounts, initramfs, and rootfs layout;
...
diagnose a program that starts before one of its filesystems or devices is available.
