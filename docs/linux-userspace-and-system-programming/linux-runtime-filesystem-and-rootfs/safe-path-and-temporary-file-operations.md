...
This page covers how to handle untrusted paths, symlinks, races, and temporary data safely. It is part of Stage 1: Linux Runtime, Filesystem, And Rootfs and focuses on behavior that must remain correct on a constrained or partially available embedded Linux target.

## Core Concepts

- the safe paths and temporary file operations contract;
...
- mental model and vocabulary for safe paths and temporary file operations;
...
replace a check-then-open sequence with descriptor-relative and atomic operations.
