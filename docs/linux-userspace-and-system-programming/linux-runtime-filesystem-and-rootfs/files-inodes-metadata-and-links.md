...
This page covers the difference between a pathname, directory entry, inode, open file, and file type. It is part of Stage 1: Linux Runtime, Filesystem, And Rootfs and focuses on behavior that must remain correct on a constrained or partially available embedded Linux target.

## Core Concepts

- the files, inodes, metadata, and links contract;
...
- mental model and vocabulary for files, inodes, metadata, and links;
...
write a metadata inspection utility using stat, lstat, and directory iteration.
