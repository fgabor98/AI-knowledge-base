...
This page covers how the loader, interpreter, shared libraries, and ABI determine whether a program can start. It is part of Stage 1: Linux Runtime, Filesystem, And Rootfs and focuses on behavior that must remain correct on a constrained or partially available embedded Linux target.

## Core Concepts

- the elf executables and dynamic linking contract;
...
- mental model and vocabulary for elf executables and dynamic linking;
...
use file, readelf, and loader diagnostics to investigate an ENOENT or missing-library failure.
