...
This page covers what procfs, sysfs, devtmpfs, debugfs, and configfs represent. It is part of Stage 1: Linux Runtime, Filesystem, And Rootfs and focuses on behavior that must remain correct on a constrained or partially available embedded Linux target.

## Core Concepts

- the pseudo-filesystems and device nodes contract;
...
- mental model and vocabulary for pseudo-filesystems and device nodes;
...
correlate a device node with its sysfs object, driver, and process descriptors.
